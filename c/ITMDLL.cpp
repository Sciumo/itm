...
void DllExport STDCALL qlrps(double fmhz, double zsys, double en0,
...
double DllExport STDCALL alos(double d, prop_type &prop, propa_type &propa) {
...
void DllExport STDCALL qlra(int kst[], int klimx, int mdvarx,
...
void DllExport STDCALL lrprop(double d,
...
double DllExport STDCALL adiff(double d, prop_type &prop, propa_type &propa) {
...
double DllExport STDCALL ascat(double d, prop_type &prop, propa_type &propa) {
  std::complex<double> prop_zgnd(prop.zgndreal, prop.zgndimag);
...
double DllExport STDCALL avar(double zzt, double zzl, double zzc,
     prop_type &prop, propv_type &propv) {
  static int kdv;
...
void DllExport STDCALL hzns(double pfl[], prop_type &prop) {
  bool wq;
  int np;
...
void DllExport STDCALL z1sq1(double z[], const double &x1, const double &x2,
           double &z0, double &zn) {
...
double DllExport STDCALL qtile(const int &nn, double a[], const int &ir) {
  double q, r;
  int m, n, i, j, j1, i0, k;
  bool done = false;
  bool goto10 = true;
...
double DllExport STDCALL d1thx(double pfl[], const double &x1, const double &x2) {
  int np, ka, kb, n, k, j;
...
void DllExport STDCALL qlrpfl(double pfl[], int klimx, int mdvarx,
...
void DllExport STDCALL point_to_point(double elev[], double tht_m, double rht_m,
...
void DllExport STDCALL point_to_pointMDH(double elev[], double tht_m, double rht_m,
                  double eps_dielect, double sgm_conductivity, double eno_ns_surfref,
...
void DllExport STDCALL point_to_pointDH(double elev[], double tht_m, double rht_m,
                 double eps_dielect, double sgm_conductivity, double eno_ns_surfref,
                 double frq_mhz, int radio_climate, int pol, double conf, double rel,
...
void DllExport STDCALL area(long ModVar, double deltaH, double tht_m, double rht_m,
...
double DllExport STDCALL ITMAreadBLoss(long ModVar, double deltaH, double tht_m, double rht_m,
              double dist_km, int TSiteCriteria, int RSiteCriteria,
              double eps_dielect, double sgm_conductivity, double eno_ns_surfref,
              double frq_mhz, int radio_climate, int pol, double pctTime, double pctLoc,
              double pctConf) {
...
double  DllExport STDCALL ITMDLLVersion() {
  return ITMVERSION;
}